        ...
        <div class="mx-auto max-w-lg px-6 lg:px-8 absolute py-20">
            ...
            <div class="rounded-2xl bg-white shadow-xl">
                <form method="post" action="/login" class="lg:p-11 p-7 mx-auto">
                    ...
                    <a href="/register" class="flex justify-center text-gray-900 text-lg font-medium leading-6">Belum
                        punya akun?<span
                            class="text-primary font-semibold pl-3 no-underline hover:underline hover:text-secondary">Daftar</span>
                    </a>
                </form>
            </div>
        </div>
